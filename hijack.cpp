...
{
	if(0);
	else if (!strcmp(name, "CreateProcessA")) return (void*)myCreateProcessA;
	else if (!strcmp(name, "ShellExecuteA")) return (void*)myShellExecuteA;
	else if (!strcmp(name, "ShellExecuteEx")) return (void*)myShellExecuteExA;
	else if (!strcmp(name, "ShellExecuteExA")) return (void*)myShellExecuteExA;
	//else if (!strcmp(name, "MessageBoxA")) return (void*)myMessageBoxA;
	else if (!strcmp(name, "GetProcAddress")) return (void*)myGetProcAddress;
	else if (!strcmp(name, "CheckTokenMembership")) return (void*)myCheckTokenMembership;
	else if (0)
	{
...
//say("\n");
		...
		// if OriginalFirstThunk, the names are still available, but no point doing different things
